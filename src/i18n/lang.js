const Lang = {
    "en-us": {
        ...
        form: {
            ...
            emailPlaceholder: 'john.smith@tbs-sct.gc.ca, john.smith@ssc-spc.gc.ca, etc',
    ...
    "fr-ca": {
        ...
        form: {
            ...
            emailPlaceholder: 'jeanne.tremblay@tbs-sct.gc.ca, jeanne.tremblay@ssc-spc.gc.ca, etc.',
