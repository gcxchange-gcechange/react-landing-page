...
const ToolkitEn = () => (
    <main className="text-center">
        ...
        <ul>
            ...
            <li> resource test image: <img src={"https://stscmafiles.blob.core.windows.net/gcxchange/Black_hole_-_Messier_87.jpg?sp=r&st=2021-08-17T18:05:31Z&se=2021-09-21T02:05:31Z&spr=https&sv=2020-08-04&sr=c&sig=OUqyWxXGbzPov7WVGwhEiSwrnZvilc9PMrv9NqyUdew%3D"} /></li>
        </ul>
        </div>
    </main>
)
